 ...
 */
export declare function resolveProjectRoot(worktree: string | undefined, directory: string | undefined, opts?: {
    cwd?: () => string;
 ...
 */
export declare function getPreEditGuide(sidecar: SidecarLike, filePath: string, projectRoot: string): Promise<string | null>;
 ...
 */
export declare function checkSessionConflict(sidecar: SessionCheckSidecar, currentSessionId: string, projectRoot: string): Promise<string | null>;
interface TddTransitionSidecar {
    tddTransition(action: "confirm_red" | "confirm_green", specId?: string): Promise<{
        count: number;
    }>;
}
/**
 ...
 */
export declare function transitionTddState(sidecar: TddTransitionSidecar, action: "confirm_red" | "confirm_green", specId?: string): Promise<void>;
export {};
