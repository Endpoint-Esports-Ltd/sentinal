...
**Symptom:** When an orphaned sidecar process receives SIGTERM, it deletes the _current_ sidecar's PID/port/socket files, breaking MCP connectivity for the active sidecar.
