...
const lines = [
  ...
  " *",
  " * Generated by: bun scripts/embed-assets.mjs",
  " *",
  ...
  " *",
  " * This file is intentionally NOT committed to git (see .gitignore); it is",
  " * regenerated by build:cli, release-build.mjs, the npm `prepare` hook, and",
  " * the bunfig test preload. Output must stay deterministic — do not add",
  " * timestamps or other non-reproducible content.",
  " */",
  "",
  "// ═══════════════════════════════════════════════════════════════════════════════",
  "// OpenCode Assets",
